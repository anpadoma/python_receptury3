# Przykład 3. Obsługa struktury zagnieżdżonej

import struct

class StructField:
    '''
    Deskryptor reprezentujący pole prostej struktury
    '''
...
class NestedStruct:
    '''
    Deskryptor reprezentujący strukturę zagnieżdżoną
    '''
...
class StructureMeta(type):
    '''
    Metaklasa automatycznie tworząca deskryptory typu StructField
    '''
